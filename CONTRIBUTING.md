...
of guidelines for contributing to Baquex, which are hosted in the
[GitHub](https://github.com/Tap30/baquex). These are mostly guidelines, not
...
[Code of Conduct](https://github.com/Tap30/baquex/blob/main/CODE_OF_CONDUCT.md).
...
[good first issues](https://github.com/Tap30/baquex/issues?q=is:open+is:issue+label:"good+first+issue")
...
[good to take issues](https://github.com/Tap30/baquex/issues?q=is:open+is:issue+label:"good+to+take").
...
7. Go to [the repository](https://github.com/Tap30/baquex) and make a Pull
   Request.
